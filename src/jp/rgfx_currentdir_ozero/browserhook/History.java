...
public class History {
	...
	private static final String DATABASE_NAME = "timestamps";
	private static final String DATABASE_TABLE = "timestamps";
	private static final int DATABASE_VERSION = 3;
	
	private int maxRowNumLimit= 50;
	 ...
	 */
	public long createItem(String url, String timestamp) {
	...
	public Cursor fetchItem(long rowid) throws SQLException {
		...
		Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] {
				KEY_ROWID, KEY_URL, KEY_TIMESTAMP }, KEY_ROWID + "="
	 ...
	 *             if item could not be found/retrieved
	 */
	public Cursor fetchItemById(int id) throws SQLException {
	 ...
	 * values passed in
	 */
	public boolean updateItem(long rowId, String url, String timestamp) {
